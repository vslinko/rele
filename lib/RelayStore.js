...
class Collection {
  ...
  toArray() {
    ...
    const items = saved.concat(unsaved).map(item => {
...
export default class RelayStore extends Store {
  ...
  hasUncompletedRequests() {
    return Object.keys(this.createRequests).length > 0 || Object.keys(this.updateRequests).length > 0;
  }
